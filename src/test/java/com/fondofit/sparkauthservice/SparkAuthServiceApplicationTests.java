package com.fondofit.sparkauthservice;

import com.fondofit.sparkauthservice.domain.Role;
import com.fondofit.sparkauthservice.domain.User;
import com.fondofit.sparkauthservice.domain.UserRole;
...
@SpringBootTest(classes = { SparkAuthServiceApplication.class })
@AutoConfigureMockMvc
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD)
class SparkAuthServiceApplicationTests {
